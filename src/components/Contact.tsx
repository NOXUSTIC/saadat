        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 mt-8">
            <div className="flex items-center">
              <div className="w-12 h-12 rounded-full bg-purple-100 dark:bg-purple-900/20 flex items-center justify-center text-purple-600 mr-4">
              ...
              <div>
                ...
                <a href="mailto:saadat20022002@gmail.com" className="text-lg hover:text-purple-600 transition-colors">
