        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-8 md:mb-0 animate-fade-in">
            <a href="#home" className="font-bold text-xl flex items-center gap-2">
              ...
              <span className="text-white">S. Rahman</span>
            </a>
          ...
          <div className="mb-8 md:mb-0 animate-fade-in text-white" style={{animationDelay: "0.2s"}}>
          ...
          <div className="animate-fade-in text-white" style={{animationDelay: "0.4s"}}>
