  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-16">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute right-0 top-1/3 w-96 h-96 bg-purple-500/20 rounded-full filter blur-3xl" />
        <div className="absolute left-20 bottom-1/4 w-64 h-64 bg-purple-600/20 rounded-full filter blur-3xl" />
      </div>
      ...
      <div className="container px-4 sm:px-6 flex flex-col items-center text-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 tracking-tight animate-fade-up">
          Hi, I'm <span className="text-purple-600">Saadat S. Rahman</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 animate-fade-up" style={{animationDelay: "0.3s"}}>
          <Button className="bg-purple-600 hover:bg-purple-700 text-lg px-6 py-6" asChild>
        ...
        <div className="mt-16 sm:mt-20 animate-fade-up" style={{animationDelay: "0.4s"}}>
          <div className="flex justify-center items-center gap-6">
            <a 
              ...
              className="p-2 rounded-full bg-background border border-border hover:border-purple-500 transition-colors"
            >
